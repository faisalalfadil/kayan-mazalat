      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <div className="text-lg font-bold">كيان القمة</div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white/10 hover:bg-primary text-white/70 hover:text-white flex items-center justify-center text-sm font-bold transition-all duration-200 hover:-translate-y-0.5"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/60 text-sm">info@kayanalqimah.com</span>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-right">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} كيان القمة. جميع الحقوق محفوظة.
          </p>
