        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              تأسست مؤسسة كيان القمة على مبدأ الجودة والابتكار، مقدمين حلولاً متكاملة لا تقتصر على المظلات والسواتر، بل تشمل أيضاً خبرتنا في تنفيذ واجهات الزجاج والكلادينج، لتوفير مظهر عصري وعملي للمباني.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              نقدم خدمات ديكورات داخلية متكاملة تشمل بديل الخشب والرخام والباركيه والجبس بورد، بالإضافة إلى تركيب ألواح الساندوتش بانل للمستودعات والهناجر. نلتزم بمعايير الجودة العالمية في جميع مشاريعنا.
            </p>
