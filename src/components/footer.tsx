        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              مؤسسة متخصصة في تصميم وتنفيذ المظلات الكهربائية وبديل الشيبود والديكورات الداخلية على مستوى المملكة العربية السعودية. نقدم حلولاً متكاملة بأعلى معايير الجودة.
            </p>
