        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              نقدم خدمات ديكورات داخلية متكاملة تشمل بديل الخشب والرخام والباركيه والجبس بورد، بالإضافة إلى بديل الشيبود بتصاميم عصرية ومتانة عالية. نلتزم بمعايير الجودة العالمية في جميع مشاريعنا.
            </p>
